...
namespace SiteDeals.MVCWebUI.Areas.Identity.Pages.Account
{
    ...
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<SiteDealsMVCWebUIUser> signInManager,
        ...
        public async Task<IActionResult> OnPostAsync(string? returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    var userForEmail = await _userManager.FindByEmailAsync(Input.EmailOrUsername);
                    if (userForEmail != null)
                    {
                        Input.EmailOrUsername = userForEmail.UserName;
                    }
                }
